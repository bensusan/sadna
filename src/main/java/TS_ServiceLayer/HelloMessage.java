...
public class HelloMessage {
	...
	public static enum functionNames {addImmediatelyProduct, addLotteryProduct, removeProductFromCart, editProductAmount, editProductDiscount, editProductPrice, editCart, purchaseCart, addProductToStore, deleteProductFromStore, updateProductDetails, addPolicyToProduct, addDiscountToProduct, addNewStoreOwner, addNewManager, closeStore, openStore, getPurchaseHistory, removeSubscriber, viewSubscriberHistory, viewStoreHistory, signUp, signIn, expiredProducts, changeStorePurchasePolicy, getAllStoresWithThierProductsAndAmounts, getAllStores, getAllSubscriberStores, getSubscriberFromUsername, getProductAndAmountPerStoreId, getAllSubscribersWithPotential, changeProductType, addDiscountToCategoryStore};
