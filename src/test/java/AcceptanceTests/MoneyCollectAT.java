...
public class MoneyCollectAT {
	...
	//9
	@Test
	private void testMoneyCollection(){
		
		//test payment

		assertFalse(BlStore.payToStore(so.getStore(), -100, "123456789123"));
		assertFalse(BlStore.payToStore(so.getStore(), 100, "213dasd564ad"));
		Store storeNull = null;
		assertFalse(BlStore.payToStore(storeNull, 100, "123456789123"));
		
		assertTrue(BlStore.payToStore(so.getStore(), 100, "123456789123"));	
